...
public class LaserScript : MonoBehaviour
{
    ...
    void Update()
    {
        // Instantiate the start of the laser if it doesn't exist
        if (start == null)
        {
        ...
        // Instantiate the middle of the laser if it doesn't exist
        if (middle == null)
        {
        ...
        // Raycast at the right as our sprite has been designed for that
        ...
        middle.transform.localScale = new Vector3(currentLaserSize - startSpriteWidth - endSpriteWidth, middle.transform.localScale.y, middle.transform.localScale.z);
        middle.transform.localPosition = new Vector2((currentLaserSize - startSpriteWidth - endSpriteWidth) / 2f + startSpriteWidth, 0f);

        // Position the end part of the laser
        if (end != null)
        {
